...
class lib_test extends \advanced_testcase {
    ...
    /**
     * Test mod_tiddlywiki_core_calendar_provide_event_action with user override
     */
    public function test_tiddlywiki_core_calendar_provide_event_action_user_override() {
        global $CFG, $USER;
        ...
        // Decorate action event.
        $actionevent = mod_tiddlywiki_core_calendar_provide_event_action($event, $factory, $USER->id);

        // Decorate action with a userid override.
        $actionevent2 = mod_tiddlywiki_core_calendar_provide_event_action($event, $factory, $user->id);
