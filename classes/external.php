    ...
    public static function get_tiddlywikis_by_courses($courseids = array()) {
        ...
        if (!empty($params['courseids'])) {
            ...
            foreach ($tiddlywikis as $tiddlywiki) {
                ...
                helper_for_get_mods_by_courses::format_name_and_intro($tiddlywiki, 'mod_tiddlywiki');
                $tiddlywiki->contentfiles = util::get_area_files($context->id, 'mod_tiddlywiki', 'content');
